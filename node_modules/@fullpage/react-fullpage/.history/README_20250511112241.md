...
Props object can contain standard [options](https://alvarotrigo.com/fullPage/docs/#options) as well as fullPage.js [callbacks](https://github.com/alvarotrigo/fullPage.js#callbacks).
